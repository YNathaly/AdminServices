                        ...
                        <tbody id="table_services">
                            @foreach ($datos['services'] as $e)
                                <tr id="serviceRow{{$e->id}}">
                                    ...
                                    <td> {{$e->comentarios_evento}} </td>
                                    <td class="text-center"><a  class="btn btn-link btn-xs actualizar"  title="Seguimiento" href="{{url('evento_id',$e->id_evento)}}" id="{{$e->id_evento}}"><span class="fa fa-file-o fa-2x"></span></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>

                        ...
                        <tbody id="table_services">
                            @foreach ($datos['services'] as $e)
                                <tr id="serviceRow{{$e->id}}">
                                    ...
                                    <td> {{$e->descripcion}} </td>
                                    <td> {{$e->comentarios}} </td>
                                    <td class="text-center"><a  class="btn btn-link btn-xs actualizar"  title="Actualizar cliente" id="{{$e->id}}"><span class="fa fa-refresh fa-2x"></span></a></td>
                                    <td class="text-center"><a  class="btn btn-link text-danger btn-xs eliminar"  id="{{$e->id}}" title="Eliminar Cliente"><span class="fa fa-close fa-2x"></span></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
